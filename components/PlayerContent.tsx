...
import * as Sliderbar from '@radix-ui/react-slider';
...
const PlayerContent: React.FC<PlayerContentProps> = ({
  ...
  return (
    <div className="grid grid-cols md:grid-cols-3 h-full">
        ...
        step={1}
        >
        <Sliderbar.Track className="bg-blackA10 relative grow rounded-full h-[3px]">
            <Sliderbar.Range className="absolute bg-white rounded-full h-full" />
        </Sliderbar.Track>
        <Sliderbar.Thumb
